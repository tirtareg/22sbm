...
```{r}
data <- read_excel("G:/My Drive/#PMB/2022/02_SBMPTN/22sbm/311_Statistik_Keketatan_Prodi.xlsx")
data <- data[,-2]
...
### Berikut adalah daftar nama mahasiswa baru Universitas Sultan Ageng Tirtayasa jalur SBMPTN (**gunakan Search untuk pencarian cepat**).
